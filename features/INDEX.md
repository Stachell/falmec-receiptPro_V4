...
| PROJ-18 | Run-Detail UI-Refinement | Done | Symmetrische Abstände (KPI↔Tab-Leiste, Tab-Leiste↔Body je 24 px). Expand/Collapse-Logik (ChevronsDown/Up, animate-pulse, max-h-Transition 500 ms) für RE-Positionen, Artikelliste, Lagerort-Details und XML-Vorschau. Spalten-Rename in Artikelliste: DE→Art-# (DE), Artikel-# (IT)→Art-# (IT). |
